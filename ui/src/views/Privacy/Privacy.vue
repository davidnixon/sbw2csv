  ...
  <cv-grid>
    <cv-row>
      <cv-column>
        ...
        <p>
          Your privacy is important to us. It is SBW2CSV&#39;s policy to respect
          ...
          across our website,
          <a href="https://sbw2csv.mybluemix.net/"
            >https://sbw2csv.mybluemix.net/</a
          >, and other sites we own and operate.
        </p>
        <p>
          This policy is effective as of 13 August 2021 and was last updated on
          13 August 2021.
        </p>
        ...
        <p>
          ...
          all details that identify you. <br /><br />
          Typically files you upload and convert will be
          <b>deleted within minutes</b>.
        </p>
        <p>
        ...
        <p>
          Admin<br />
          https://github.com/davidnixon/sbw2csv/issues
        </p>
      </cv-column>
    </cv-row>
  </cv-grid>
