...
extern void gb_marshal_VOID__INT_INT(GClosure *closure, GValue *return_value,
...
extern void gb_marshal_VOID__INT_DOUBLE(GClosure *closure, GValue *return_value,
                                        guint n_param_values,
                                        const GValue *param_values,
                                        gpointer invocation_hint,
                                        gpointer marshal_data);
...
extern void
gb_marshal_VOID__DOUBLE_DOUBLE(GClosure *closure, GValue *return_value,
...
extern void gb_marshal_BOOLEAN__OBJECT(GClosure *closure, GValue *return_value,
                                       guint n_param_values,
                                       const GValue *param_values,
                                       gpointer invocation_hint,
                                       gpointer marshal_data);
