...
/*=========================================================================*/
const gchar *gb_series_fmt(gbSeries series) {
  switch (series) {
  case GB_SERIES_E:
    return "E";
  case GB_SERIES_S:
...
/*=========================================================================*/
gchar *gb_value_fmt(gdouble value, gboolean cent_flag) {
...
/*=========================================================================*/
gbStatus gb_determine_yield(gdouble issue_price, gdouble value, gbDate idate,
                            gbDate adate, gdouble *yield) {
  gdouble months;
  ...
  if (months > 0) {
    ...
    *yield =
        2.0 * (exp((6.0 / months) * log(value / issue_price)) - 1.0) * 100.0;
#endif
  } else {
    *yield = 0.0;
  }
