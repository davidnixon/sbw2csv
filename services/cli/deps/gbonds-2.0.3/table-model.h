...
#define GB_TABLE_MODEL(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GB_TYPE_TABLE_MODEL, gbTableModel))
#define GB_TABLE_MODEL_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GB_TYPE_TABLE_MODEL, gbTableModelClass))
#define GB_IS_TABLE_MODEL(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GB_TYPE_TABLE_MODEL))
#define GB_IS_TABLE_MODEL_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GB_TYPE_TABLE_MODEL))
...
GList *gb_table_model_get_rdate_list(gbTableModel *table_model, gint max_dates);
